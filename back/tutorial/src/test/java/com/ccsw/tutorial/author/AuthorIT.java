...
public class AuthorIT {
    ...
    ParameterizedTypeReference<ResponsePage<AuthorDto>> responseTypePage =
            new ParameterizedTypeReference<ResponsePage<AuthorDto>>() {
            };
    ...
    public void saveWithoutIdShouldCreateNewAuthor() {
        ...
        AuthorDto author = response.getBody().getContent().stream().filter(
                item -> item.getId().equals(newAuthorId)).findFirst().orElse(null);
    ...
    public void modifyWithExistIdShouldModifyAuthor() {
        ...
        restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + "/" + MODIFY_AUTHOR_ID,
        ...
        AuthorDto author = response.getBody().getContent().stream().filter(
                item -> item.getId().equals(MODIFY_AUTHOR_ID)).findFirst().orElse(null);
        assertNotNull(author);
        assertEquals(NEW_AUTHOR_NAME, author.getName());
    ...
    public void deleteWithExistsIdShouldDeleteCategory() {
        ...
        restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + "/" + DELETE_AUTHOR_ID, HttpMethod.DELETE,
                null, Void.class);
